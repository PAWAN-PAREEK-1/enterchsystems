      ...
      <div className="index">
        <div className={styles.aboutMain}>
          ...
          <div className={styles.right}>
                    <h4>ABOUT US</h4>
                    <h1>Outstanding <span>Residential & Commercial Services</span> </h1>
                    ...
                    <div className={styles.work}>
                        <h5><Image src={right}/>Electrical Consultancy </h5>
                        <h5><Image src={right}/>Project Documentation </h5>
                        <h5><Image src={right}/>Retrofitting </h5>
                        <h5><Image src={right}/>Break down service </h5>
                    </div>
